...
from compress_tools_v2.integrations import (  # isort: split
            ...
            if self.args.mpo_lr == -1:
                ...
                if self.args.update_mpo_layer and self.args.update_mpo_layer.lower() != 'noupdate':
                    ...
                    if 'attention' in self.args.update_mpo_layer:
                        update_mpo_layer.extend(['query_mpo.tensor_set','key_mpo.tensor_set','value_mpo.tensor_set','dense_mpo.tensor_set'])
                    if 'FFN_1' in self.args.update_mpo_layer:
                        update_mpo_layer.extend(['ffn_mpo.tensor_set'])
                    if 'FFN_2' in self.args.update_mpo_layer:
                        update_mpo_layer.extend(['ffn_output_mpo.tensor_set'])
                else:
                    update_mpo_layer = ['embeddings.word_embeddings_mpo.tensor_set',  # embedding
                                'query_mpo.tensor_set','key_mpo.tensor_set','value_mpo.tensor_set',#,'dense_mpo.tensor_set', # attention
                                'ffn_mpo.tensor_set','ffn_output_mpo.tensor_set',"pooler_mpo.tensor_set"] # ffn and ffn_output
